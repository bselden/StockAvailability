...
### vast.new.lim New VAST output: read in Density_DF.csv, merge with knot area, calculate TotalBio, rbind into one file for all species, limit to survey years
### some knots had an area=0, so were removed in vast.new.lim
### cc.lim Thorson Pinsky Ward VAST output, read in Density_list, melt density matrix in $Density_kgperkm2 (actually TotalBio), label with knots and years, rbind into one file for all species, limit to survey years
load("Output/TPWvsnewVASToutput.RData", verbose=T)
# =====================================
# = COG =
# =====================================
...
plot(cog_N ~ year, cog_orig[spp_common=="sablefish"], type="o", ylim=c(4500,5000),
